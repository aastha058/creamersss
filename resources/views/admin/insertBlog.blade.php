        ...
        <div class="row">
            ...
            <div class="col-lg-9 mt-5 ">
                ...
                <div class="form-container p-4 bg-white shadow rounded-4">
                    <form action="{{ route('blog.store') }}" method="POST" class="custom-form"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="title" name="author" value="{{ old('author') }}"
                        ...
                        <div class="form-actions mt-4">
                            <input type="submit" value="Insert Blog" class="btn btn-primary btn-lg rounded-3 w-100"
